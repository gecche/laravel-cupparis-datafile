...
namespace Cupparis\App\Datafileproviders;

use \Cupparis\Ardent\Ardent;
use Cupparis\Datafile\ArdentDatafile;
...
class ComuneIstat extends ArdentDatafileProvider
{
	/*
    ...
    protected $modelDatafileName = 'ComuneIstat';
    protected $modelTargetName = 'ComuneIstat';
