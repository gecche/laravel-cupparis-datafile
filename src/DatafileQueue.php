...
//            Log::info('Datafile provider name: '. $datafileProviderName);
            ...
            $sheetsNames = Datafile::getSheetsNames();
            foreach ($sheetsNames as $sheetName) {

                Datafile::setCurrentSheet($sheetName);
...
//            Log::info('hereENDENF3');
    ...
    public function save($job, $data)
    {
        ...
        try {
            ...
            Datafile::getDatafile();
            $sheetsNames = Datafile::getSheetsNames(true);
            Datafile::beforeSave();
            foreach ($sheetsNames as $sheetName) {
                Datafile::setCurrentSheet($sheetName, null, true);
